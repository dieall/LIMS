...
<div class="panel-body">
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb bg-light rounded">
            ...
            <li class="breadcrumb-item active" aria-current="page">Tambah Data Sn/Ag/Cu Series</li>
        </ol>
        <hr>
    </nav>
</div>
...
<div class="card shadow mb-4">
    <div class="card-header py-3 d-flex justify-content-between align-items-center">
        <h6 class="m-0 font-weight-bold">Tambah Data Sn/Ag/Cu Series</h6>
    </div>
    ...
    <div class="card-body">
        ...
        <!-- Form Utama -->
        <form action="{{ route('snagcu.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
            <input type="hidden" name="tipe_solder" id="formType" value="SAC0307"> <!-- Default ke opsi pertama -->
            ...
            <select id="solderType" class="form-control">
                <option value="SAC0307">SAC0307</option>
                <option value="SAC0307 (A)">SAC0307 (A)</option>
                <option value="E9650 (2.9% Ag)">E9650 (2.9% Ag)</option>
                <option value="E9650 (3% Ag)">E9650 (3% Ag)</option>
                <option value="E9650 (A) (2.9% Ag)">E9650 (A) (2.9% Ag)</option>
                <option value="E9650 (A) (3% Ag)">E9650 (A) (3% Ag)</option>
            </select>
        </div>
                <!-- Batch / Lot -->
                <div class="col-md-6 mb-3">
