        ...
        <div class="coa-label">
                ...
                <table class="coa-table">
                    ...
                    <tr>
                        ...
                        <td><input type="text" class="form-control" name="nama" value="{{ \Carbon\Carbon::parse($pengajuanchemical->tgl)->format('d F Y') }}"></td>
                    </tr>
                    <tr>
                        <th>Type Product</th>
                        <td><input type="text"  class="form-control" name="nama" value="{{ $pengajuanchemical->nama }}"></td>
                    </tr>
                    <tr>
                        <th>Description</th>
                        <td>
...
function printData() {
    ...
    // Ganti input dan textarea dengan teks
    const inputs = clonePrintArea.querySelectorAll('input, textarea');
    ...
    // Ganti select (dropdown) dengan teks pilihan yang dipilih
    const selects = clonePrintArea.querySelectorAll('select');
