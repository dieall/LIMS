...
<div class="card shadow mb-4">
    ...
    <div class="card-body">
        ...
        <!-- Form Utama -->
        <form action="{{ route('snag.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
            <input type="hidden" name="tipe_solder" id="formType" value="0307CX"> <!-- Default ke opsi pertama -->
            ...
            <select id="solderType" class="form-control">
                <option value="0307CX">0307CX</option>
                <option value="0507CX">0507CX</option>
                <option value="9650CX (2.9% Ag)">9650CX (2.9% Ag)</option>
                <option value="9650CX (3% Ag)">9650CX (3% Ag)</option>
                <option value="9650CX (B) (2.9% Ag)">9650CX (B) (2.9% Ag)</option>
            </select>
        </div>
                <!-- Batch / Lot -->
                <div class="col-md-6 mb-3">
