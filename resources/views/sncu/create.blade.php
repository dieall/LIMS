...
<div class="card shadow mb-4">
    ...
    <div class="card-body">
        ...
        <form action="{{ route('sncu.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
            <input type="hidden" name="tipe_solder" id="formType" value="D9930C"> <!-- Default ke opsi pertama -->
            ...
            <select id="solderType" class="form-control">
                <option value="D9930C">D9930C</option>
                <option value="D9930C (A)">D9930C (A)</option>
                <option value="D9930C (W)">D9930C (W)</option>
                <option value="MB D9930C">MB D9930C</option>
                <option value="NAP100">NAP100</option>
            </select>
        </div>
                <!-- Batch / Lot -->
                <div class="col-md-6 mb-3">
