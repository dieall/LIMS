...
<body>
    ...
    <div class="container-fluid sticky-top">
        <div class="container">
            <nav class="navbar navbar-expand-lg navbar-light bg-white py-lg-0 px-lg-3">
                ...
                <img src="{{ asset('admin_assets/img/photos/login.png') }}" alt="Company Logo" class="img-fluid" style="max-width: 130px; height: auto; max-height: auto;">
                </a>
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    ...
                    <img src="{{ asset('admin_assets/img/photos/login.png') }}" alt="Company Logo" class="img-fluid" style="max-width: 150px; height: auto; max-height: auto;">
                    </div>
                </div>
            </nav>
        </div>
        ...
        <div id="header-carousel" class="carousel slide carousel-fade" data-bs-ride="carousel">
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img class="w-100" src="{{ asset('landing_assets/img/carousel-1.jpg') }}" alt="Image">
                ...
                <div class="carousel-item">
                    <img class="w-100" src="{{ asset('landing_assets/img/carousel-2.jpg') }}" alt="Image">
                    <div class="carousel-caption">
                        <div class="container">
        ...
        <div class="container">
            <div class="row g-5">
                <div class="col-lg-6 wow fadeIn" data-wow-delay="0.1s">
                    <div class="row g-0">
                        <div class="col-6">
                            <img class="img-fluid" src="{{ asset('landing_assets/img/about-1.jpg') }}">
                        </div>
                        <div class="col-6">
                            <img class="img-fluid" src="{{ asset('landing_assets/img/about-2.jpg') }}">
                        </div>
                        <div class="col-6">
                            <img class="img-fluid" src="{{ asset('landing_assets/img/about-3.jpg') }}">
                        </div>
                        <div class="col-6">
            ...
            <div class="row g-5 py-5">
                <div class="col-lg-6 pe-lg-5">
                    <a href="index.html" class="navbar-brand">
                        <h1 class="h1 text-primary mb-0">PT TIMAH <span class="text-white"> INDUSTRI</span></h1>
                    </a>
    ...
    <script src="{{ asset('landing_assets/lib/counterup/counterup.min.js') }}"></script>
