    ...
    <div class="card-body">
        <form action="{{ route('timchen.store') }}" method="POST">
            ...
            <div class="mb-3" id="kode-bqr-container" style="display:none;">
                ...
                <input type="text" name="id" class="form-control" id="id" readonly value="TCZ-139 M">
            </div>
            ...
            <table class="table table-striped table-bordered">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>Max 15</td>
                        <td>Spectrophotometric</td>
                        <td><input type="text" name="yellow" class="form-control"></td>
                    </tr>
                    <tr>
                        <td>6</td>
                        <td>Water Content</td>
                    ...
                    <input type="hidden" name="tin" class="form-control" value="">
                    <input type="hidden" name="ri" class="form-control" value="">
                    <input type="hidden" name="sg" class="form-control" value="">
                    <input type="hidden" name="acid" class="form-control" value="">
                    <input type="hidden" name="sulfur" class="form-control" value="">
                </tbody>
            </table>
